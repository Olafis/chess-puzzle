    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mt-2 text-zinc-900 dark:text-white">로그인</h1>
          <p className="text-zinc-600 dark:text-zinc-400 text-sm mt-1">PuzzleChess에 오신 것을 환영합니다</p>
        </div>
        ...
        <div className="space-y-2 mb-6">
          <button
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 text-sm font-medium hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-colors"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-zinc-600 dark:text-zinc-400 mb-1.5">비밀번호</label>
            <input
              type="password"
              value={password}
